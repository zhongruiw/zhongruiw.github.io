...
subtitle: The discrete-time filtering formulation differs from its continuous-time counterpart. The difference is revealed by looking at the observations, which should be noted with caution to avoid potential confusion.
layout: blog_post
date: 2025-05-08
